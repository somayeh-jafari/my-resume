      ...
      <div className="container lg:pt-5">
        <div className="text-center">
          ...
          <p className="lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7 ">
            ...
            Voluptatibus mollitia alias nulla ipsa, delectus unde debitis
            doloremque placeat suscipit quaerat. Neque repellendus tenetur qui
            facere dolor cum a obcaecati soluta!
          </p>
        </div>
            ...
            <div className="relative text-gray-700 antialiased text-sm font-semibold">
              ...
              <div className="mt-6 sm:mt-0 sm:mb-12 ">
                <div className="flex items-center flex-col sm:flex-row">
                  ...
                  >
                    <img src={frontendImg} alt="programmer" />
                  </div>
                </div>
              </div>
              {/* ================right card================ */}
              <div className="mt-6 sm:mt-0 sm:mb-12 ">
                <div className="flex items-center flex-col sm:flex-row">
                  ...
                  transform -translate-x-1/2 -translate-y-4 sm:translate-y-0 flex items-center justify-center "
                  >
                    <img src={backendImg} alt="programmer" />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 sm:mt-0 sm:mb-12 ">
                <div className="flex items-center flex-col sm:flex-row">
                  ...
                  transform -translate-x-1/2 -translate-y-4 sm:translate-y-0 flex items-center justify-center "
                  >
                    <img src={appsImg} alt="programmer" />
                  </div>
                </div>
              </div>
            </div>
